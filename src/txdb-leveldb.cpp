...
extern int dw_zip_txdb;  // 2016.02.02 add
extern void bitnet_depack_Db_DataStream(CDataStream& ssValue);
extern void bitnet_pack_Db_DataStream(CDataStream& ssValue);
...
bool CTxDB::LoadBlockIndex()
{
    ...
    while (iterator->Valid())
    {
        ...
        if (fRequestShutdown || strType != "blockindex")
            break;
        if( dw_zip_txdb > 0 ) bitnet_depack_Db_DataStream(ssValue);
