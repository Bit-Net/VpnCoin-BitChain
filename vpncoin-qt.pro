...
contains(USE_TXMSG, 1) {
    message(This coin support Tx Msg)
    DEFINES += USE_TXMSG
}
...
contains(USE_WEBKIT, 1) {
    message(Building with SuperNet support)
    DEFINES += USE_WEBKIT
...
HEADERS += src/qt/bitcoingui.h \
    ...
    src/qt/bitchainpage.h \
    src/protocol.h \
    src/qt/notificator.h \
    src/qt/qtipcserver.h \
    src/qt/mypushbutton.h \
...
SOURCES += src/qt/bitcoin.cpp src/qt/bitcoingui.cpp \
    ...
    src/qt/mystyle.cpp \
    src/qt/bitchainpage.cpp \
    src/protocol.cpp \
    src/qt/notificator.cpp \
    src/qt/qtipcserver.cpp \
    src/qt/rpcconsole.cpp \
    src/qt/mypushbutton.cpp \
...
SOURCES += src/qt/forms/mainframe.cpp
...
macx:ICON = src/qt/res/icons/VpnCoin.icns
macx:TARGET = "VpnCoin-Qt"
